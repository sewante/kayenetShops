<%-- 
    Document   : weekly-sales
    Created on : Apr 18, 2019, 4:15:30 PM
    Author     : rober
--%>
...
<html>
    <head>
        ...
        <title>Kayenet | Weekly sales</title>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li class="active"><a  href="weekly-sales.jsp">Weekly Sales</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Weekly Sales</h3>
          	<div class="row mt">
                    <div class="col-lg-12">
