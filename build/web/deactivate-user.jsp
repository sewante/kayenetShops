<%-- 
    Document   : deactivate-user
    Created on : Apr 18, 2019, 5:27:40 PM
    Author     : rober
--%>
...
<html>
    <head>
        ...
        <title>Kayenet | deactivate-user</title>
    ...
    <body>
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <header class="header black-bg">
              ...
              <!--logo start-->
              <a href="deactivate-user.jsp" class="logo"><b>KAYENET SHOPS</b></a>
              <!--logo end-->
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li class="active"><a  href="deactivate-user.jsp">Deactivate User</a></li>
                      </ul>
                  </li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Deactivate a User</h3>
          	<div class="row mt">
                    <div class="col-lg-12">
