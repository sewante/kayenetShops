<%-- 
    Document   : daily-sales
    Created on : Apr 18, 2019, 4:15:06 PM
    Author     : rober
--%>
...
<html>
    <head>
        ...
        <title>Kayenet | Daily sales</title>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        <li class="active"><a  href="daily-sales.jsp">Daily Sales</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Daily Sales</h3>
          	<div class="row mt">
                    <div class="col-lg-12">
