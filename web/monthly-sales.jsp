<%-- 
    Document   : monthly-sales
    Created on : Apr 18, 2019, 4:16:02 PM
    Author     : robert
--%>
...
<html>
    <head>
        ...
        <title>Kayenet | Monthly sales</title>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li class="active"><a  href="monthly-sales.jsp">Monthly Sales</a></li>
                      </ul>
                  </li>
                  <!-- Products -->
                  <li class="sub-menu">
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
            <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Monthly Sales</h3>
          	<div class="row mt">
                    <div class="col-lg-12">
