<%-- 
    Document   : sales-product-gallery
    Created on : Apr 21, 2019, 12:00:56 PM
    Author     : rober
--%>
    ...
    <body>
        ...
        *********************************************************************************************************************************************************** -->
        ...
        <header class="header black-bg">
              ...
              <!--logo start-->
              <a href="sales-product-gallery.jsp" class="logo"><b>KAYENET SHOPS</b></a>
              <!--logo end-->
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <h5 class="centered"><% out.print(session.getAttribute("salesPersonName")); %>
                  </h5>
              	  <!-- Dashboard Welcome -->	
                  <li class="mt">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                        ...
                        <li class="active"><a  href="sales-product-gallery.jsp">Product Gallery</a></li>
                      </ul>
                  </li>
